    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-6xl">
        ...
        <Reveal className="mb-16">
          <article className="overflow-hidden rounded-3xl border border-white/[0.08] bg-white/[0.02] backdrop-blur-sm">
            <div className="grid items-center gap-10 p-6 sm:p-8 lg:grid-cols-[1fr_minmax(240px,0.95fr)] lg:gap-12 lg:p-10">
              <div className="order-2 space-y-5 lg:order-1">
                ...
                <p className="text-sm leading-relaxed text-zinc-400 sm:text-base">
                  Participei do desenvolvimento do aplicativo <strong className="text-zinc-200">Rota</strong>, pensado
                  para aproximar pessoas do que importa na cidade: <strong className="text-zinc-200">notícias</strong>{' '}
                  locais, <strong className="text-zinc-200">alertas</strong> (como meteorologia e avisos úteis),{' '}
                  <strong className="text-zinc-200">serviços</strong> e conteúdos que organizam a rotina urbana — tudo
                ...
                <div className="flex flex-wrap gap-2 pt-1">
                  {['React Native', 'Mobile UI', 'TypeScript', 'Consumo de APIs'].map((s) => (
                    <span
                      key={s}
                      className="rounded-full border border-pink-500/25 bg-pink-500/10 px-3 py-1 font-mono text-[11px] text-pink-200/90"
                    >
                      {s}
                    </span>
                  ))}
            ...
            <div className="grid items-center gap-10 p-6 sm:p-8 lg:grid-cols-[minmax(280px,1.05fr)_1fr] lg:gap-12 lg:p-10">
              ...
              <div className="order-2 space-y-5">
                ...
                <p className="text-sm leading-relaxed text-zinc-400 sm:text-base">
                  ...
                  <strong className="text-zinc-200">controle do sistema de campanhas de mídia (ads)</strong> do{' '}
                  <strong className="text-zinc-200">Grupo Coruja</strong>, reunindo visão operacional, de cliente e
                ...
                <p className="text-sm leading-relaxed text-zinc-400 sm:text-base">
                  O projeto se organiza em <strong className="text-zinc-200">três frentes</strong>: o{' '}
                  <strong className="text-zinc-200">painel administrativo</strong>, a área voltada ao{' '}
                  <strong className="text-zinc-200">cliente</strong> e o{' '}
                  <strong className="text-zinc-200">aplicativo</strong>. Atuei nos{' '}
                  <strong className="text-zinc-200">três modelos</strong>, tanto em{' '}
                  <strong className="text-zinc-200">front quanto em back</strong>: nas experiências web usei{' '}
                  <strong className="text-zinc-200">Next.js</strong> ponta a ponta (interface e camada server-side),
                  enquanto no app mobile trabalhei com <strong className="text-zinc-200">React Native</strong> para as
          ...
          <article className="overflow-hidden rounded-3xl border border-white/[0.08] bg-white/[0.02] backdrop-blur-sm">
            <div className="grid items-center gap-10 p-6 sm:p-8 lg:grid-cols-[1fr_minmax(280px,1.05fr)] lg:gap-12 lg:p-10">
              <div className="order-2 space-y-5 lg:order-1">
                ...
                <p className="text-sm leading-relaxed text-zinc-400 sm:text-base">
                  Participei do desenvolvimento do site <strong className="text-zinc-200">YEP</strong>, focado em{' '}
                  <strong className="text-zinc-200">vendas de produtos</strong> e{' '}
                  <strong className="text-zinc-200">scooters elétricas</strong>: vitrine, detalhes de modelo, fluxo de
                ...
                <p className="text-sm leading-relaxed text-zinc-400 sm:text-base">
                  ...
                  <strong className="text-zinc-200">painel administrativo hierárquico</strong>, desenhado para três
                  níveis: <strong className="text-zinc-200">administradores</strong>,{' '}
                  <strong className="text-zinc-200">lojas e franqueadores</strong> e a{' '}
                  <strong className="text-zinc-200">empresa principal (matriz)</strong>. Cada perfil enxerga o que
                ...
                <p className="text-sm leading-relaxed text-zinc-500 sm:text-base">
                  Foi um desafio legal de <strong className="text-zinc-300">modelagem de papéis</strong> e de{' '}
                  <strong className="text-zinc-300">APIs</strong> que sirvam tanto o site quanto as operações internas,
        ...
        >
          {otherProjects.map((p) => (
            <motion.li key={p.title} variants={item}>
              <a
                href={p.href}
                className="group flex h-full flex-col rounded-2xl border border-white/[0.08] bg-white/[0.03] p-6 backdrop-blur-sm transition hover:border-pink-500/35 hover:bg-white/[0.06]"
              >
                ...
                <div className="mt-5 flex flex-wrap gap-2">
                  {p.stack.map((s) => (
                    <span
                      key={s}
                      className="rounded-full border border-pink-500/25 bg-pink-500/10 px-2.5 py-0.5 font-mono text-[11px] text-pink-200/90"
                    >
                      {s}
                    </span>
                  ))}
