...
function HomePage() {
  return (
    <div className="bg-black min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 min-h-screen items-center justify-center px-4 sm:px-6 lg:px-8">
              ...
              <div className="space-y-6">
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <h2 className="text-2xl sm:text-3xl text-pink-400 font-semibold tracking-wide">
                      Desenvolvedora Frontend
                    </h2>
                    <div className="w-24 h-1 bg-gradient-to-r from-pink-400/50 to-pink-500/50 rounded-full mx-auto lg:mx-0"></div>
                  </div>
                </div>
        ...
        <div className="flex items-center justify-center py-8">
          <div className="flex items-center justify-center lg:justify-start gap-6">
            <div className="flex items-center gap-2 text-pink-400">
              <div className="w-3 h-3 bg-pink-400 rounded-full animate-pulse shadow-lg shadow-pink-500/50"></div>
